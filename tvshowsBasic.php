        ...
        echo '  
				...
				<div class="card" style="width: 18rem; background-color:#dae0e5;">
				  ...
				  <center>
					...
					<a href="tvshowBasic.php?id='.$row['id'].'" class="btn btn-secondary btn-lg" role="button"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Infobox_info_icon.svg/1200px-Infobox_info_icon.svg.png" width="25" height="25"></a> 
					</center>
				  </div>
				</div>
