<?php # DISPLAY COMPLETE LOGGED IN PAGE.
	...
	include ( 'includes/categoryBarBasic.html' ) ;
...
<script>
  ...
  <?php # DISPLAY COMPLETE LOGGED IN PAGE.
    ...
    $page_title = 'Whats on' ;
    //include ( 'logout.html' ) ;
	include ( 'includes/logoutBasic.php' ) ;		
    # Open database connection.
    require ( 'includes/connect_db.php' ) ;
    ...
    if ( mysqli_num_rows( $r ) > 0 )
    {
        ...
        echo '  
				...
				<div class="card" style="width: 100%; background-color:#dae0e5; margin: 10px,10px,10px,10px">
				
				  <img class="card-img-top" src='. $row['img'].' alt="Movie" height="75%">
				  <div class="card-body">
				  <center>
					<h5 class="card-title">'.$row['movie_title'].'</h5>
					
					
					<a href="movieBasic.php?id='.$row['id'].'" class="btn btn-secondary btn-lg" role="button"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Infobox_info_icon.svg/1200px-Infobox_info_icon.svg.png" width="25" height="25"></a> 
					</center>
				  </div>
				</div>
    ...
    # Or display message.
    else { echo '<p>There are currently no records to display showing.</p>';}
