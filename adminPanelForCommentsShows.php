...
<center>
	<h1>TV Show review database information.<h1>
	<hr>
...
';
  ...
  while ( $row = mysqli_fetch_array( $r, MYSQLI_ASSOC ))
  {
   ...
   <table style="background-color: white; width: 100%">
    <tr>
   <th>Post ID: ' . $row['post_id'] . ' <br>Title: ' . $row['tvshow_title'] . ' </th></center>
  </tr>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                # Display form.
                echo '					  	    
	  <center><h2 class="modal-title" id="rev">DELETE TV show review</h2>
	  ...
	  <form action="deleteTVShowsReview.php" method="post" accept-charset="utf-8">
				<div class="form-check">
				
						<label for="post_id">TV Show review ID: </label>
				...
				<div class="form-group">
					<div class="modal-footer">
						...
						<input class="btn btn-danger" type="submit" value="DELETE TV SHOW REVIEW">
					</div>
				</div>
		</form>
      </div>  
