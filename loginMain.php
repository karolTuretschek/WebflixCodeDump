...
<div class="card" style="width: 34rem; height: auto; background-color:#dae0e5; border-radius: 50px 50px 50px 50px">
	<center>		<div class="card-body">
			<h1>Choose your login option</h1>
			<br><br>
<div class=row>			
			<form  action="login.php" method="post">													
			<center><p><input class="btn btn-secondary btn-lg" type="submit" value="Premium User" style="width: 12rem;"></p></center>
			</form>	
			<h1>&nbsp;&nbsp;<h1>
			<form  action="loginBasic.php" method="post">													
			<center><p><input class="btn btn-secondary btn-lg" type="submit" value="Basic User" style="width: 12rem;"></p></center>
			</form>	
</div>			
			<hr>
			<br>
		  ...
		  <form  action="adminLogin.php" method="post">			
			<p1><input type="submit" value="Admin" style="width: 5rem;"></p1>
			</form>
		  </div>
