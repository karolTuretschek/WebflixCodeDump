...
<?php # DISPLAY COMPLETE LOGGED IN PAGE.
    ...
    if ( mysqli_num_rows( $r ) > 0 )
    {
        ...
        echo '  
				...
				<div class="card" style="width: 18rem; background-color:#dae0e5;">
				
				  <img class="card-img-top" src='. $row['img'].' alt="Tvshows">
				  <div class="card-body">
				  <center>
					<h5 class="card-title">'.$row['tvshow_title'].'</h5>
					
					<a href="https://www.youtube.com/watch?v=ZVb_yKMivqo"  target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-lg" role="button"><img src="https://cdn3.iconfinder.com/data/icons/iconic-1/32/play_alt-512.png" width="25" height="25"></a>
					<a href="tvshow.php?id='.$row['id'].'" class="btn btn-secondary btn-lg" role="button"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Infobox_info_icon.svg/1200px-Infobox_info_icon.svg.png" width="25" height="25"></a> 
					</center>
				  </div>
				</div>
