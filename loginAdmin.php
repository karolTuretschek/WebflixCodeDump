...
.card{
    ...
    transform: translate(-50%, -50%);
		  ...
		  <body>
			...
			<p><input class="form-control" type="text" name="email" placeholder="Email address" required autofocus style="width: 16rem;"></p>
			...
			<p><input class="btn btn-secondary btn-lg" type="submit" value="Status" style="width: 16rem;"></p>
			</form>
