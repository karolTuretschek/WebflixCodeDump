...
# Retrieve items from 'movie' database table.
$q = "SELECT * FROM movie" ;
...
';
  ...
  <tr>
   <th>ID: ' . $row['id'] . ' <br>Title:' . $row['movie_title'] . ' </th></center>
  </tr>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                # Display form.
                echo '
				<center><h2 class="modal-title" id="rev">ADD NEW MOVIE</h2>
				<h5 class="modal-title" id="rev">Provide movie data and press ADD MOVIE to complete movie addition.</h5></center>
				<form action="post_actionMovie.php" method="post" accept-charset="utf-8">
				...
				<div class="form-group">
					<div class="modal-footer">
						...
						<input class="btn btn-dark" type="submit" value="ADD MOVIE">
					</div>
				</div>
		</form>
      </div>
	  
	  <center><h2 class="modal-title" id="rev">EDIT MOVIE</h2>
	  <h5 class="modal-title" id="rev">Choose movie ID and provide the rest of movie information. Complete edition by pressing UPDATE MOVIE.</h2></center>
	  <form action="updateMovies.php" method="post" accept-charset="utf-8">
				<div class="form-check">
				...
				<div class="form-group">
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						<input class="btn btn-dark" type="submit" value="UPDATE MOVIE">
					</div>
				</div>
		</form>
      </div>
	  ...
	  <center><h2 class="modal-title" id="rev">DELETE MOVIE</h2>
	  <h5 class="modal-title" id="rev">Choose movie ID and predd DELETE.</h5>
	  <h5 class="modal-title" id="rev">This process is irreverstable. Take care when deleting files.</h5></center>
	  <form action="deleteMovies.php" method="post" accept-charset="utf-8">
				<div class="form-check">
