    ...
    echo '
		...
		<br>
			...
			<p><b>&nbsp'.$row['further_info'].'</b></p>
                ...
                &nbsp<img src="http://cdn.onlinewebfonts.com/svg/img_537319.png" width="25" height="25" alt="icon">&nbsp'.$row['outon'].'
                ...
                <h2>
				<hr>				
				<a href="mov-rev.php?movie_title='.$row['movie_title'].'"> <button type="button" class="btn btn-secondary" role="button">Reviews</button></a>
                </h2>
                </hr> 
